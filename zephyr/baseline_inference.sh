...
python zephyr_baseline_inference.py --task_type summarization --prompt_type zero-shot & wait
python zephyr_baseline_inference.py --task_type summarization --prompt_type few-shot
